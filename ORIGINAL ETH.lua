...
if localVersion ~= version then
    OrionLib:MakeNotification({Name = "Script version mismatch!", Content = "You seem to have an older version of Ethereon. Original Loadstring has been copied", Image = "rbxassetid://4483345998", Time = 8})
...
local Window = OrionLib:MakeWindow({
    Name = "Ethereon - Latest: " .. version, 
    HidePremium = false, 
    SaveConfig = false, 
    ConfigFolder = "Ethereon", 
    IntroEnabled = true, 
    IntroText = "Ethereon" ..version, 
...
OrionLib:MakeNotification({Name = "Welcome", Content = "Welcome to Ethereon ", Image = "rbxassetid://4483345998", Time = 5})
OrionLib:Init()
